...
class Feedback(models.Model):
    ...
    title = models.CharField(max_length=500)
    description = models.TextField(blank=True, help_text='This wiill be viewable by other people - do not include any private details such as passwords or phone numbers here.')
